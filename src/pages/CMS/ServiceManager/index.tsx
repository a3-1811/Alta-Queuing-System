...
const [table, setTable] = useState({
  ...
  return (
    <div className="services content pl-[24px] pt-[29px] pr-[100px] relative">
      ...
      />
      {/* Add button */}
      <Link to="/services-management/add" className="absolute -right-28 top-0 flex flex-col h-[94px] w-20 justify-center items-center text-center bg-primary-50 text-primary font-bold cursor-pointer hover:text-primary"><i className="fa fa-plus-square text-xl"></i><span className="text-sm">Thêm dịch vụ</span></Link>
      </div>
